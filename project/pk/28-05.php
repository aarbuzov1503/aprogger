...
<h1 style="color: #ff0000;">Проверяйте порядок и правильность заполнения полей! Фамилия и Имя</h1>
...
<script>
  ...
  function countdown() {
    ...
    if (timer <= 0) {
      window.location = 'https://iframeab-pre6992.intickets.ru/seance/17837074/#abiframe'; // перенаправляем на страницу регистрации пользователей
    } else {
