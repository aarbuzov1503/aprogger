...
<html lang="ru">
    <head>
        ...
        <title>Регистрация бизнеса (ИП и ООО)</title>
        <style>
body {
...
window.yaContextCb.push(()=>{
	Ya.Context.AdvManager.render({
        ...
        <h2>Регистрация бизнеса (ИП и ООО)</h2>
...
<script>
  ...
  function countdown() {
    ...
    if (timer <= 0) {
      window.location = 'https://alfabank.ru/sme/start/partner/ag/?platformId=alfapartners_msv_RKOregbiz_292755_2206336&utm_source=alfapartners&utm_medium=msv&utm_term=RKOregbiz&utm_campaign=292755&utm_content=alfapartners_msv_RKOregbiz_292755_2206336'; // перенаправляем на страницу регистрации пользователей
    } else {
