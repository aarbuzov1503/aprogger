...
<html lang="ru">
    <head>
        ...
        <title>Платёжное кольцо для бесконтактной оплаты</title>
        <style>
body {
...
window.yaContextCb.push(()=>{
	Ya.Context.AdvManager.render({
        ...
        <h2>Платёжное кольцо для бесконтактной оплаты уже почти у вас!</h2>
...
<script>
  ...
  function countdown() {
    ...
    if (timer <= 0) {
      window.location = 'https://alfabank.ru/everyday/package/premium/rings/?platformId=alfapartners_msv_DC-rings_292755_2205899&utm_source=alfapartners&utm_medium=msv&utm_term=DC-rings&utm_campaign=292755&utm_content=alfapartners_msv_DC-rings_292755_2205899'; // перенаправляем на страницу регистрации пользователей
    } else {
