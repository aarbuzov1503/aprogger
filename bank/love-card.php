...
<html lang="ru">
    <head>
        ...
        <title>Альфа-Карта с любимым кэшбэком</title>
        <style>
body {
...
window.yaContextCb.push(()=>{
	Ya.Context.AdvManager.render({
        ...
        <h2>Альфа-Карта с любимым кэшбэком</h2>
...
<script>
  ...
  function countdown() {
    ...
    if (timer <= 0) {
      window.location = 'https://alfabank.ru/lp/retail/dc/flexible-agent/?platformId=alfapartners_msv_DC-flexible_292755_2235137&utm_source=alfapartners&utm_medium=msv&utm_term=DC-flexible&utm_campaign=292755be&utm_content=alfapartners_msv_DC-flexible_292755_2235137'; // перенаправляем на страницу регистрации пользователей
    } else {
