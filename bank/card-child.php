...
<script>
  ...
  function countdown() {
    ...
    if (timer <= 0) {
      window.location = 'https://alfabank.ru/lp/retail/dc/childcard-agent/?platformId=alfapartners_msv_DC-childcard_292755_2206275&utm_source=alfapartners&utm_medium=msv&utm_term=DC-childcard&utm_campaign=292755&utm_content=alfapartners_msv_DC-childcard_292755_2206275'; // перенаправляем на страницу регистрации пользователей
    } else {
