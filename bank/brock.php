...
<script>
  ...
  function countdown() {
    ...
    if (timer <= 0) {
      window.location = 'https://alfabank.ru/make-money/investments/brokerskij-schyot/?platformId=alfapartners_msv_investment-ba_292755_2206394&utm_source=alfapartners&utm_medium=msv&utm_term=investment-ba&utm_campaign=292755&utm_content=alfapartners_msv_investment-ba_292755_2206394'; // перенаправляем на страницу регистрации пользователей
    } else {
