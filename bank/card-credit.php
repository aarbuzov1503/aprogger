...
<html lang="ru">
    <head>
        ...
        <title>Кредитная карта Целый год без процентов</title>
        <style>
body {
...
window.yaContextCb.push(()=>{
	Ya.Context.AdvManager.render({
        ...
        <h2>Кредитная карта Целый год без процентов уже почти у вас!</h2>
...
<script>
  ...
  function countdown() {
    ...
    if (timer <= 0) {
      window.location = 'https://alfabank.ru/get-money/credit-cards/land/365-days-partners/?platformId=alfapartners_msv_CC-365_292755_3091352&utm_source=alfapartners&utm_medium=msv&utm_term=CC-365&utm_campaign=292755&utm_content=alfapartners_msv_CC-365_292755_3091352'; // перенаправляем на страницу регистрации пользователей
    } else {
