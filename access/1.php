...
<script src="https://yandex.ru/ads/system/context.js" async></script>
  ...
  <?php
    $timer = 90; // начальное значение таймера
?>
 <div class="container">
...
<div id="yandex_rtb_R-A-6902447-2"></div>
<script>
...
<script>
  ...
  function countdown() {
    ...
    if (timer <= 0) {
      window.location = 'https://aprogger.ru/access/2.php'; // перенаправляем на страницу регистрации пользователей
    } else {
