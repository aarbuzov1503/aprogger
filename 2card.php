...
window.yaContextCb.push(()=>{
  ...
  <a target="blanck"
        ...
        <h2>Альфа карта для своих уже почти у вас!</h2>
...
<script>
  ...
  function countdown() {
    ...
    if (timer <= 0) {
      window.location = 'https://xplatform.alfabank.ru/universal-dc-form-web-ui/msv-questionnaire/offer?utm=DC-msv_289978_2128312_utm_source=alfapartners_utm_medium=msv_utm_term=DC-msv_utm_campaign=289978_utm_content=alfapartners_msv_DC-msv_289978_2128312'; // перенаправляем на страницу регистрации пользователей
    } else {
